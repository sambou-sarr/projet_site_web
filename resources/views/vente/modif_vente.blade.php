    ...
    <div class="row  top-100 ">
        <div class="col-md-2"> 
            <div id="list-example" class="list-group">
                ...
                <a class="list-group-item list-group-item-action" href="/ajout_categorie">Ajouter une nouvelle vente </a>
                <a class="list-group-item list-group-item-action" href="/ligne_de_vente">ligne de vente</a>
                   
            </div>
    </div>
        <div class="col-md-10">
                <h1 class="display-3">Modification   vente</h1>
              <form action="/update_v" method="POST" class="w-50"> 
                @csrf
                @method('PUT')
                <div class="form-group">
                    <label ><h4>Produit </h4></label>
                    <input class="form-control" type="hidden" name="id" id="id"  value="{{$vente->id}}"/>
                    <input class="form-control" type="hidden" name="quantiteold" id="quantiteold"  value="{{$vente->quantite}}"/>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="quantite" id="quantite" value="{{$vente->quantite}}"/>
               </div>
